...
public class BookingController {
    ...
    @RequestMapping(value="bookings/{bookingId}",method=RequestMethod.GET,produces=MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value="bookings/{bookingId}",method=RequestMethod.DELETE,produces=MediaType.APPLICATION_JSON_VALUE)
