...
public class SeatmanagementController {
    ...
    @RequestMapping(value = "seatmanagements",method = RequestMethod.GET,produces =MediaType. APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value="/seatmanagements/{seatId}",method=RequestMethod.GET,produces=MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value="seatmanagements",method=RequestMethod.POST,produces=MediaType.APPLICATION_JSON_VALUE)
...
//        return new ResponseEntity<>(HttpStatus.OK);
    ...
    @RequestMapping(value="seatmanagements",method=RequestMethod.PUT,produces=MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Seatmanagement> CreateSeatmanagement(@RequestBody Seatmanagement seatmanagement){
        Seatmanagement CreatedSeatmanagement=seatmanagementService.createSeatmanagement(seatmanagement);
        return Optional.ofNullable(CreatedSeatmanagement)
                .map(u->ResponseEntity.ok().body(u))
    ...
    @RequestMapping(value="seatmanagements/{seatId}",method=RequestMethod.DELETE,produces=MediaType.APPLICATION_JSON_VALUE)
