...
public class PaymentController {
    ...
    @RequestMapping(value="Payment/{paymentId}",method=RequestMethod.GET,produces=MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value="Payment/{paymentId}",method=RequestMethod.DELETE,produces=MediaType.APPLICATION_JSON_VALUE)
