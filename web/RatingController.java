...
public class RatingController {
    ...
    @RequestMapping(value="Rating",method=RequestMethod.PUT,produces=MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Rating> CreateRating(@RequestBody Rating rating){
        Rating CreatedRating=ratingService.createRating(rating);
        return Optional.ofNullable(CreatedRating)
                .map(u->ResponseEntity.ok().body(u))
    ...
    @RequestMapping(value="Rating/{id}",method=RequestMethod.DELETE,produces=MediaType.APPLICATION_JSON_VALUE)
