...
public class TheatreController {
    ...
    @RequestMapping(value="Theatre",method= RequestMethod.GET,produces= MediaType.APPLICATION_JSON_VALUE)
    public List<Theatre> getTheatres(){
        return theatreService.getAllTheatres();
    }

    @RequestMapping(value="Theatre/{theatreId}",method=RequestMethod.GET,produces=MediaType.APPLICATION_JSON_VALUE)
    public Theatre getTheatreById(@PathVariable("theatreId") Integer theatreId){
        return theatreService.getTheatreById(theatreId);
    }

    @RequestMapping(value="Theatre",method=RequestMethod.POST,produces=MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value="Theatre",method=RequestMethod.PUT,produces=MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Theatre> CreateTheatre(@RequestBody Theatre theatre){
        Theatre CreatedTheatre=theatreService.createTheatre(theatre);
        return Optional.ofNullable(CreatedTheatre)
                .map(u->ResponseEntity.ok().body(u))
    ...
    @RequestMapping(value="Theatre/{theatreId}",method = RequestMethod.DELETE,produces=MediaType.APPLICATION_JSON_VALUE)
